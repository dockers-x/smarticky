...
func IsStarred(v bool) predicate.Folder {
	return predicate.Folder(sql.FieldEQ(FieldIsStarred, v))
}
...
func IsStarredEQ(v bool) predicate.Folder {
	return predicate.Folder(sql.FieldEQ(FieldIsStarred, v))
}

// IsStarredNEQ applies the NEQ predicate on the "is_starred" field.
func IsStarredNEQ(v bool) predicate.Folder {
	return predicate.Folder(sql.FieldNEQ(FieldIsStarred, v))
}
...
func HasNotes() predicate.Folder {
	return predicate.Folder(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasNotesWith(preds ...predicate.Note) predicate.Folder {
	return predicate.Folder(func(s *sql.Selector) {
		step := newNotesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
